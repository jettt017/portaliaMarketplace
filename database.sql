-- Database initialization script for Portalia
-- Database Name: portaliadb

CREATE DATABASE IF NOT EXISTS `portaliadb`;
USE `portaliadb`;
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `item_condition` ENUM('new', 'like_new', 'used') DEFAULT 'used',
  `stock` INT DEFAULT 1,
...
-- Wishlist (Siti wishes Calculus Book, Andi wishes iPad Pro)
...
-- Transactions (Simulated mock sales logs for admin reporting)
